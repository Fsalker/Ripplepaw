module.exports = {
    init_database: (con) => {
        ...
        sql += `CREATE TABLE UserToRoom(
                    ...
                    userId int NOT NULL,
                    roomId int NOT NULL,
                    role varchar(30) NOT NULL /* spectator, red player, red spymaster, blue player, blue spymaster */
        );`
        ...
        sql += `CREATE TABLE WordToRoom(
                    ...
                    wordId int NOT NULL,
                    roomId int NOT NULL,
                    color varchar(20) /* red, blue, black */
        );`
        ...
        words = words.filter( word => word[0].length >= 3)
